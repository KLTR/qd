...
<path d="M21.586 10.461l-10.05 10.075c-1.95 1.949-5.122 1.949-7.071 0s-1.95-5.122 0-7.072l10.628-10.585c1.17-1.17 3.073-1.17 4.243 0 1.169 1.17 1.17 3.072 0 4.242l-8.507 8.464c-.39.39-1.024.39-1.414 0s-.39-1.024 0-1.414l7.093-7.05-1.415-1.414-7.093 7.049c-1.172 1.172-1.171 3.073 0 4.244s3.071 1.171 4.242 0l8.507-8.464c.977-.977 1.464-2.256 1.464-3.536 0-2.769-2.246-4.999-5-4.999-1.28 0-2.559.488-3.536 1.465l-10.627 10.583c-1.366 1.368-2.05 3.159-2.05 4.951 0 3.863 3.13 7 7 7 1.792 0 3.583-.684 4.95-2.05l10.05-10.075-1.414-1.414z"/>
    ...
    <g id="bLayer_2" data-name="Layer 2">
      <path fill="#6f859d" d="M.07 14.57h8v1h-8zm0-3h8v2h-8zm0-4h8v3h-8zm4-7.57L0 6.07h8.14L4.07 0z" id="bLayer_1-2" data-name="Layer 1" />
    </g>
    </svg>`;
            case 'collapse':
                return `<svg viewBox="0 0 11.39 7.95" id="collapse" width="${size ? size : ''}" height="${size ? size : ''}">
    <g id="cLayer_2" data-name="Layer 2">
      <path fill="#a7cff7" d="M11.39 1.41L9.98 0 6 3.98l3.98 3.97 1.41-1.41-2.56-2.56 2.56-2.57zM3.98 0L0 3.98l3.98 3.97 1.41-1.41-2.56-2.56 2.56-2.57L3.98 0z" id="cLayer_1-2" data-name="Layer 1" />
    </g>
    </svg>`;
    ...
    <g id="dLayer_2" data-name="Layer 2">
      <path fill="#a7cff7" d="M5.39 1.41L3.98 0 0 3.98l3.98 3.97 1.41-1.41-2.56-2.56 2.56-2.57z" id="dLayer_1-2" data-name="Layer 1" />
    </g>
    </svg>`;
            case 'device-active':
                return `<svg viewBox="0 0 8 14" id="device-active" width="${size ? size : ''}" height="${size ? size : ''}">
       <g id="eLayer_2" data-name="Layer 2">
      <path fill="currentColor" d="M7.44 0H.56A.56.56 0 0 0 0 .56v12.88a.56.56 0 0 0 .56.56h6.88a.56.56 0 0 0 .56-.56V.56A.56.56 0 0 0 7.44 0zm-.16.72V10H.72V.72zM3 12a1 1 0 1 1 1 1 1 1 0 0 1-1-1z" id="eLayer_1-2" data-name="Layer 1" />
    </g>
    </svg>`;
            case 'downloading':
     ...
     <g id="mLayer_2" data-name="Layer 2">
      <g id="mLayer_1-2" data-name="Layer 1">
        ...
        <g id="aaLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM66 43.58a22.49 22.49 0 0 1-22 21.23 22.21 22.21 0 0 1-21.38-14.92.78.78 0 0 1 .51-1l3.64-1.13a.76.76 0 0 1 .95.48 17 17 0 1 0 .43-12.54l3-1.65a.87.87 0 0 1 1.17.35l1.36 2.52a.86.86 0 0 1-.34 1.17l-9.14 4.95a.86.86 0 0 1-1.17-.34l-5.13-9.47a.86.86 0 0 1 .35-1.17l2.51-1.36a.86.86 0 0 1 1.17.34l1.32 2.43A22.3 22.3 0 0 1 66 43.58zm-20.2-.78l5.35 5.34a.72.72 0 0 1 0 1l-2.77 2.77a.72.72 0 0 1-1 0L40.42 45a.67.67 0 0 1-.21-.5V33.05a.72.72 0 0 1 .72-.72h3.91a.72.72 0 0 1 .72.72v9.24a.75.75 0 0 0 .21.51z" id="aaLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'alert':
                return `<svg viewBox="0 0 23.6 18.82" id="alert" width="${size ? size : ''}" height="${size ? size : ''}">
        <g id="abLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M23.34 16.4L13.12.71a1.57 1.57 0 0 0-2.63 0L.26 16.4a1.57 1.57 0 0 0 1.31 2.42H22a1.56 1.56 0 0 0 1.34-2.42zm-10.79-1.19a.24.24 0 0 1-.24.24h-1a.24.24 0 0 1-.24-.24v-1a.24.24 0 0 1 .24-.24h1a.24.24 0 0 1 .24.24zm0-2.81a.24.24 0 0 1-.24.24h-1a.24.24 0 0 1-.24-.24V6a.24.24 0 0 1 .24-.24h1a.24.24 0 0 1 .24.24z" id="abLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'apps':
                return `<svg viewBox="0 0 83 83" id="apps" width="${size ? size : '9.6vw'}" height="${size ? size : '9.6vw'}">
                      <g id="acLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM29.06 65.27a1 1 0 0 1-1 1H16.9a1 1 0 0 1-1-1V54.12a1 1 0 0 1 1-1h11.16a1 1 0 0 1 1 1zm0-18.19a1 1 0 0 1-1 1H16.9a1 1 0 0 1-1-1V35.92a1 1 0 0 1 1-1h11.16a1 1 0 0 1 1 1zm0-18.2a1 1 0 0 1-1 1H16.9a1 1 0 0 1-1-1V17.73a1 1 0 0 1 1-1h11.16a1 1 0 0 1 1 1zm19 36.39a1 1 0 0 1-1 1H35.92a1 1 0 0 1-1-1V54.12a1 1 0 0 1 1-1h11.16a1 1 0 0 1 1 1zm0-18.19a1 1 0 0 1-1 1H35.92a1 1 0 0 1-1-1V35.92a1 1 0 0 1 1-1h11.16a1 1 0 0 1 1 1zm0-18.2a1 1 0 0 1-1 1H35.92a1 1 0 0 1-1-1V17.73a1 1 0 0 1 1-1h11.16a1 1 0 0 1 1 1zm19 36.39a1 1 0 0 1-1 1H54.94a1 1 0 0 1-1-1V54.12a1 1 0 0 1 1-1H66.1a1 1 0 0 1 1 1zm0-18.19a1 1 0 0 1-1 1H54.94a1 1 0 0 1-1-1V35.92a1 1 0 0 1 1-1H66.1a1 1 0 0 1 1 1zm0-18.2a1 1 0 0 1-1 1H54.94a1 1 0 0 1-1-1V17.73a1 1 0 0 1 1-1H66.1a1 1 0 0 1 1 1z" id="acLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'battery-low':
        ...
        <g id="amLayer_2" data-name="Layer 2">
            ...
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM41.36 16.68a10.54 10.54 0 1 1-10.54 10.54 10.54 10.54 0 0 1 10.54-10.54zM61 65.91H22.62c-3 0-4.1-1.07-4.1-5.83S22 48.86 25.21 45s7.13-4.1 9.5-3 6.93 1 6.93 1H42s4.55 0 6.92-1.08 6.27-.87 9.51 3 6.69 10.36 6.69 15.11S64 65.91 61 65.91z" id="anLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
        ...
        <g id="arLayer_2" data-name="Layer 2" width="35px" height="35px">
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM44.78 64.71A1.77 1.77 0 0 1 43 66.48h-5.2a1.78 1.78 0 0 1-1.8-1.77v-28.1a1.78 1.78 0 0 1 1.78-1.77H43a1.77 1.77 0 0 1 1.77 1.77zM40.4 29.93a5.46 5.46 0 1 1 5.46-5.46 5.47 5.47 0 0 1-5.46 5.46z" id="arLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'interceptor':
        ...
        <g id="asLayer_2" data-name="Layer 2">
            <path class="ascls-1" d="M16.5 0v4.88h-1.25V0h-14A1.25 1.25 0 0 0 0 1.25V11.5a1.25 1.25 0 0 0 1.25 1.25h14V7.88h1.25v4.87h14a1.25 1.25 0 0 0 1.25-1.25V1.25A1.25 1.25 0 0 0 30.5 0z" id="asLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
        ...
        <g id="atLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M15.25 0h-14A1.25 1.25 0 0 0 0 1.25V11.5a1.25 1.25 0 0 0 1.25 1.25h14V7.88h3.5v-3h-3.5zm5.24 0v4.88h3.89v3h-3.89v4.87h14a1.25 1.25 0 0 0 1.24-1.25V1.25A1.25 1.25 0 0 0 34.5 0z" id="atLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'line':
        ...
        <g id="axLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM13.55 22.61h55.9a.3.3 0 0 1 .24.12L44 43.93l-1.07.89h-.07l-.09.06a2.21 2.21 0 0 1-1.19.35 2.11 2.11 0 0 1-1.33-.44L13.36 22.68a.28.28 0 0 1 .19-.07zm-.3 3L32.5 41.48 13.25 57zm56.5 34.48a.31.31 0 0 1-.3.3h-55.9a.31.31 0 0 1-.3-.3V60l21.1-17 4.41 3.64a4.57 4.57 0 0 0 5.64 0l4.27-3.52L69.75 60zm0-3.05L50.52 41.59l19.23-15.87z" id="axLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'map':
        ...
        <g id="azLayer_2" data-name="Layer 2">
            ...
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM40.74 62.88a33.81 33.81 0 0 1-8.21-1c-4.64 3.51-7.77 4-9 4.05a.28.28 0 0 1-.24-.46c.62-.83 2-2.64 2.79-3.77 1.08-1.49 0-2.22 0-2.22-7.92-4-13.19-11.18-13.19-19.36 0-12.57 12.45-22.76 27.82-22.76s27.85 10.19 27.85 22.76S56.1 62.88 40.74 62.88z" id="baLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'messenger':
        ...
        <g id="bcLayer_2" data-name="Layer 2">
            ...
            case 'online':
                ...
                <g id="iLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M9.64 1.75a.45.45 0 0 0-.3-.3L4.53 0A.46.46 0 0 0 4 .25L.76 6.72a.44.44 0 0 0 0 .39.47.47 0 0 0 .24.26l1.85.55-2.8 5.45a.45.45 0 0 0 .13.57.48.48 0 0 0 .28.1.48.48 0 0 0 .31-.13L8.26 7a.45.45 0 0 0 .13-.44.46.46 0 0 0-.31-.34l-1.43-.46 2.91-3.58a.45.45 0 0 0 .08-.43z" id="iLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'passwords':
        ...
        <g id="bnLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M1 0H0v10h5V0H1zm2 8H2V7h1zm4-8H6v10h5V0H7zm2 8H8V7h1zm7-8h-4v10h5V0zm-1 8h-1V7h1z" id="bnLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'telegram':
        ...
        <g id="aLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M59.34 64.56L45 57.35a5.5 5.5 0 0 1-3-4.92v-5.65c.39-.46.86-1.06 1.35-1.76a33.5 33.5 0 0 0 4.46-9A4.51 4.51 0 0 0 51 31.69v-6a4.51 4.51 0 0 0-1.49-3.35v-8.76S51.28 0 33 0 16.5 13.58 16.5 13.58v8.73a4.5 4.5 0 0 0-1.5 3.35v6a4.53 4.53 0 0 0 2.07 3.8 30.13 30.13 0 0 0 5.43 11.3v5.54a5.51 5.51 0 0 1-2.85 4.82L6.27 64.47A12.11 12.11 0 0 0 0 75.08V80h66v-4.62a12.08 12.08 0 0 0-6.64-10.82z" id="aLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'internet':
                return `<svg viewBox="0 0 54.67 54.67" id="internet" width="${size ? size : '2.53vw'}" height="${size ? size : '2.53vw'}">
        <g id="aLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M12.76 27.33a49.38 49.38 0 0 1 .45-6.67H.83A27.22 27.22 0 0 0 .83 34h12.38a49.27 49.27 0 0 1-.45-6.67zm24.15 0a45 45 0 0 0-.51-6.67H18.26a44.74 44.74 0 0 0 0 13.34H36.4a44.77 44.77 0 0 0 .51-6.67zM52 15.66A27.41 27.41 0 0 0 34.36.92a50 50 0 0 1 6.16 14.74zM41.91 27.33a51 51 0 0 1-.45 6.67h12.38a27.22 27.22 0 0 0 0-13.34H41.46a51.07 51.07 0 0 1 .45 6.67zm-6.55-11.67A44.94 44.94 0 0 0 27.67 0H27a44.94 44.94 0 0 0-7.69 15.65zM19.31 39A44.9 44.9 0 0 0 27 54.66h.67A44.9 44.9 0 0 0 35.36 39zm-5.17-23.34A50.23 50.23 0 0 1 20.3.92 27.39 27.39 0 0 0 2.63 15.66zM40.52 39a49.91 49.91 0 0 1-6.16 14.75A27.43 27.43 0 0 0 52 39zM2.63 39A27.38 27.38 0 0 0 20.3 53.75 50.17 50.17 0 0 1 14.14 39z" id="aLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'signal_no':
                return `<svg viewBox="0 0 11 13.56" id="signal_no" width="${size ? size : '4vw'}" height="${size ? size : '4vw'}"><defs><style>.cls-1-no{fill:#ff4d6a;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_10" data-name="Layer 10"><polygon class="cls-1-no" points="9 0 9 8.2 10.62 11 11 11 11 0 9 0"/><polygon class="cls-1-no" points="9 10.2 9 10.2 8 8.46 8 8.46 6 5 6 5 3.37 0.44 1.63 1.44 4.27 6 4.27 6 5 7.27 5 7.27 6 9 6 9 6.94 10.63 8.63 13.56 10.37 12.56 9.05 10.29 9 10.2"/><polygon class="cls-1-no" points="3 6 3 11 5 11 5 9.27 3.11 6 3 6"/><polygon class="cls-1-no" points="8 3 6 3 8 6.46 8 3"/><rect class="cls-1-no" y="8" width="2" height="3"/></g></g></svg>`;
            case 'signal_full':
                return `<svg viewBox="0 0 11 11" id="signal_full" width="${size ? size : '4vw'}" height="${size ? size : '4vw'}"><defs><style>.cls-1-full{fill:#c2e1ff;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_10" data-name="Layer 10"><rect class="cls-1-full" x="3" y="6" width="2" height="5"/><rect class="cls-1-full" y="8" width="2" height="3"/><rect class="cls-1-full" x="6" y="3" width="2" height="8"/><rect class="cls-1-full" x="9" width="2" height="11"/></g></g></svg>`;
            case 'signal_full_inactive':
                return `<svg viewBox="0 0 11 11" id="signal_full_inactive" width="${size ? size : '4vw'}" height="${size ? size : '4vw'}"><defs><style>.cls-1-inactive{fill:rgba(196, 225, 255, 0.4);}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_10" data-name="Layer 10"><rect class="cls-1-inactive" x="3" y="6" width="2" height="5"/><rect class="cls-1-inactive" y="8" width="2" height="3"/><rect class="cls-1-inactive" x="6" y="3" width="2" height="8"/><rect class="cls-1-inactive" x="9" width="2" height="11"/></g></g></svg>`;
            case 'signal_low':
                return `<svg viewBox="0 0 11 11" id="signal_low" width="${size ? size : '4vw'}" height="${size ? size : '4vw'}"><defs><style>.cls-1-low{fill:#4a6170;}.cls-2-low{fill:#ff4d6a;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_10" data-name="Layer 10"><rect class="cls-1-low" x="3" y="6" width="2" height="5"/><rect class="cls-2-low" y="8" width="2" height="3"/><rect class="cls-1-low" x="6" y="3" width="2" height="8"/><rect class="cls-1-low" x="9" width="2" height="11"/></g></g></svg>`;
            case 'signal_middle':
        ...
        <g id="cLayer_2" data-name="Layer 2">
            ...
            case 'complete':
                ...
                <g id="aLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M19 11.58h-1v.5A8.5 8.5 0 1 1 9 3.6v2.49a.3.3 0 0 0 .51.22l2.9-2.9a.29.29 0 0 0 0-.42L9.51.09A.3.3 0 0 0 9 .3v2.3a9.5 9.5 0 1 0 10 9.48v-.5z" id="aLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'waiting':
        ...
        <g id="fLayer_2" data-name="Layer 2">
            <path fill="currentColor" d="M78 0H5a5 5 0 0 0-5 5v73a5 5 0 0 0 5 5h73a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM60.48 64.56h-.08l-10.29-5.22A3.94 3.94 0 0 1 48 55.82v-4.06c.28-.33.62-.76 1-1.26a24 24 0 0 0 3.2-6.45 3.25 3.25 0 0 0 2.29-3.11v-4.3a3.22 3.22 0 0 0-1.07-2.4V28s1.27-9.74-11.84-9.74S29.67 28 29.67 28v6.26a3.19 3.19 0 0 0-1.08 2.4v4.3a3.25 3.25 0 0 0 1.49 2.73A21.57 21.57 0 0 0 34 51.75v4a4 4 0 0 1-2 3.46l-9.56 5.25a29.87 29.87 0 1 1 38.11.13z" id="fLayer_1-2" data-name="Layer 1" />
        </g>
    </svg>`;
            case 'update_failed':
    ...
    <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
            <path fill="#a7cff7"
                  d="M9,8H1A1,1,0,0,0,0,9V35a1,1,0,0,0,1,1H16a1,1,0,0,0,1-1V17l-1-.75V29H1V9H8.5ZM8.5,34A1.5,1.5,0,1,1,10,32.5,1.5,1.5,0,0,1,8.5,34Z"/>
            <path fill="#6cfff8"
                  d="M16.5,0A8.5,8.5,0,1,0,25,8.5,8.51,8.51,0,0,0,16.5,0ZM17,15.91V13H16v2.91A7.42,7.42,0,0,1,9.09,9H12V8H9.09a8.27,8.27,0,0,1,.12-1,7.51,7.51,0,0,1,1.55-3.23,6.89,6.89,0,0,1,1-1A7.43,7.43,0,0,1,16,1.08V4h1V1.08a7.43,7.43,0,0,1,4.23,1.68,6.89,6.89,0,0,1,1,1A7.51,7.51,0,0,1,23.79,7a8.27,8.27,0,0,1,.12,1H21V9h2.91A7.42,7.42,0,0,1,17,15.91Z"/>
    ...
    <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
            <path fill="#6a8699"
                  d="M9,8H1A1,1,0,0,0,0,9V35a1,1,0,0,0,1,1H16a1,1,0,0,0,1-1V17l-1-.75V29H1V9H8.5ZM8.5,34A1.5,1.5,0,1,1,10,32.5,1.5,1.5,0,0,1,8.5,34Z"/>
            <path fill="#ff4d6a"
                  d="M16.5,0A8.5,8.5,0,1,0,25,8.5,8.51,8.51,0,0,0,16.5,0Zm0,15.94A7.45,7.45,0,0,1,9.21,7a7.51,7.51,0,0,1,1.55-3.23,6.89,6.89,0,0,1,1-1,7.43,7.43,0,0,1,9.46,0,6.89,6.89,0,0,1,1,1A7.51,7.51,0,0,1,23.79,7a7.45,7.45,0,0,1-7.29,8.94Z"/>
    ...
    <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
            <path fill="#6a8699"
                  d="M16,0H1A1,1,0,0,0,0,1V27a1,1,0,0,0,1,1H16a1,1,0,0,0,1-1V1A1,1,0,0,0,16,0ZM8.5,26A1.5,1.5,0,1,1,10,24.5,1.5,1.5,0,0,1,8.5,26ZM16,21H1V1H16Z"/>
        </g>
    </g>
</svg>`;
    ...
    <g id="Layer_2" data-name="Layer 2">
        ...
        <path id="aeye" class="eye-password" d="M1236 986.99c-3.09 0-5.95-1.919-7.87-5.264l-.13-.233.13-.232c1.92-3.346 4.78-5.264 7.87-5.264s5.95 1.918 7.86 5.264l.14.232-.14.233c-1.91 3.345-4.78 5.264-7.86 5.264zm-7.11-5.5c1.77 2.957 4.35 4.648 7.11 4.648s5.34-1.691 7.1-4.648c-1.76-2.957-4.34-4.647-7.1-4.647s-5.34 1.693-7.11 4.65zm7.09 2.948a3 3 0 1 1 2.6-2.973 2.8 2.8 0 0 1-2.6 2.976zm0-5.1a2.144 2.144 0 1 0 1.85 2.123 2 2 0 0 0-1.85-2.116z" transform="translate(-1228 -976)" />
</svg>`;
            case 'alice-green': 
